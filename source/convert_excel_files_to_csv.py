...
def convert_excel_to_csv(input_dir, output_dir):
    ...
    for excel_file in excel_files:
        try:
            ...
            csv_filename = os.path.join(output_dir, os.path.basename(excel_file).replace('.xlsx', '.csv'))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", "-i", required=True, help="The directory containing the Excel files.")
    parser.add_argument("--output_dir", "-o", required=True, help="The directory to save the converted CSV files.")
